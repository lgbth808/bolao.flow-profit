...
INSERT INTO "new_Game" ("brazilScore", "createdAt", "hidePredictionsUntilLocked", "id", "kickoffAt", "opponent", "opponentFlag", "opponentScore", "phase", "predictionRule", "status", "updatedAt", "valorBolao") SELECT "brazilScore", "createdAt", "hidePredictionsUntilLocked", "id", "kickoffAt", "opponent", "opponentFlag", "opponentScore", "phase", "predictionRule", "status", "updatedAt", "valorBolao" FROM "Game";
DROP TABLE "Game";
